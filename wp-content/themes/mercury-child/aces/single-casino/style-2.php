...
$casino_devices = get_the_terms($post->ID, 'device');
?>
...
<script type="application/ld+json">
	{
		...
		"itemReviewed": {
		    "@type": "Organization",
		    "name": "<?php the_title(); ?>",
		    "image": "<?php $src_schema = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-135-135');
            ...
            <div class="space-content-section box-75 left relative">
                ...
                <div class="space-page-content-wrap relative">
                    ...
                    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                        ...
                        <?php if ($casino_software || $casino_deposit_methods || $casino_withdrawal_methods || $casino_withdrawal_limits || $casino_restricted_countries || $casino_licences || $casino_languages || $casino_currencies || $casino_devices) { ?>

                            <!-- Casino Details Start -->

                            <div class="space-casino-details box-100 relative">
                                <div class="space-casino-details-title box-100 relative additional-text-style">
                                ...
                                <?php if ($casino_software) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/pazle.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_deposit_methods) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/credit_card.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_withdrawal_methods) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/wallet.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_withdrawal_limits) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/coins.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                            ...
                                            <?php foreach ($casino_withdrawal_limits as $limit) {
                                                ...
                                                if ($limit_logo) { ?>
                                                    <a href="<?php echo esc_url(get_term_link((int)$limit->term_id, $limit->taxonomy)); ?>"
                                                       title="<?php echo esc_attr($limit->name); ?>" class="logo-item">
                                ...
                                <?php if ($casino_restricted_countries) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/flag.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_licences) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/doc.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_languages) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/languages.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_currencies) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/carencies.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                ...
                                <?php if ($casino_devices) { ?>
                                    ...
                                    <div class="space-casino-details-item box-100 relative">
                                        <div class="space-casino-details-item-title box-33 relative">
                                            <?= get_img_html("casino-icons/computer.svg", "tcb-icons") ?>
                                            <div class="tcb-span-desc">
                                            ...
                                            <?php foreach ($casino_devices as $device) {
                                                ...
                                                if ($device_logo) { ?>
                                                    <a href="<?php echo esc_url(get_term_link((int)$device->term_id, $device->taxonomy)); ?>"
                                                       title="<?php echo esc_attr($device->name); ?>" class="logo-item">
                ...
                /*if ($bonus_args) {
                   ...
                   <!-- <div class="space-related-items box-100 read-more-block relative">
                        <div class="space-related-items-ins space-page-wrapper relative">
                            <div class="space-block-title relative">
                                <span><?php the_title(); ?> Сasino <?php esc_html_e('Bonuses', 'mercury'); ?></span>
                            </div>
