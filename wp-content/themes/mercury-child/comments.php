					...
					<div class="space-comments-ins case-15 white relative">
						<div class="space-comments-wrap space-page-content relative">
							...
							if ( have_comments() ) : ?>
								...
								<h3 class="comment-first-title">JackpotCity Casino Review
									<!-- <?php
							...
							$comments_args = array(
								...
								'comment_field'        => '<p class="comment-form-comment"><textarea id="comment" name="comment" cols="45" rows="8"  aria-required="true" required="required" placeholder="'. esc_attr__( 'Review*', 'mercury' ) .'"></textarea></p>',
