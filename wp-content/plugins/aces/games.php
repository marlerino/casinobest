...
<div class="components-base-control game_rating_one">
	<div class="components-base-control__field">
		...
		<div class="aces-single-rating-box">
			<label>
				<input type="radio" name="game_rating_one" value="1" <?php checked( $game_rating_one, '1' ); ?>>
					<?php esc_attr_e( '1', 'aces' ); ?>
			</label>
			<label>
				<input type="radio" name="game_rating_one" value="2" <?php checked( $game_rating_one, '2' ); ?>>
					<?php esc_attr_e( '2', 'aces' ); ?>
			</label>
			<label>
				<input type="radio" name="game_rating_one" value="3" <?php checked( $game_rating_one, '3' ); ?>>
					<?php esc_attr_e( '3', 'aces' ); ?>
			</label>
			<label>
				<input type="radio" name="game_rating_one" value="4" <?php checked( $game_rating_one, '4' ); ?>>
					<?php esc_attr_e( '4', 'aces' ); ?>
			</label>
			<label>
				<input type="radio" name="game_rating_one" value="5" <?php checked( $game_rating_one, '5' ); ?>>
