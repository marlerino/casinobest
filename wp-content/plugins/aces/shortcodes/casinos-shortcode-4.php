                        ...
                        <div class="space-casinos-3-archive-item-ins relative">
                                ...
                                <div class="space-casinos-3-archive-item-logo-ins box-100 text-center relative">
                                    <?php if ($casino_item_3_img) { ?>
                                        <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                                            <img src="<?php echo esc_url($casino_item_3_img[0]); ?>"
                                ...
                                <div class="space-casinos-3-archive-item-rating-ins box-100 text-center relative">
                                    <div class="space-casinos-3-archive-item-rating-box relative">
                                        <?php if (function_exists('wp_star_rating')) {
                                            wp_star_rating(array('rating' => $casino_overall_rating, 'type' => 'rating'));
                                        } ?>
                            ...
                            <div class="space-casinos-3-archive-item-terms box-20 relative">
                                <div class="space-casinos-3-archive-item-terms-ins box-100 text-center relative">
                                    <img class="item-terms-bonus-img"
                                         src="<?= get_template_directory_uri() ?>/images/money.png" alt="">
                            ...
                            <div class="space-casinos-3-archive-item-gameCount box-20 relative">
                                <div class="space-casinos-3-archive-item-rating-ins box-100 text-center relative">
                                    <div class="space-casinos-3-archive-item-games relative">
                                        <div class="space-casinos-3-archive-item-games relative">
                                            <img class="item-games-img"
                                                 src="<?= get_template_directory_uri() ?>/images/game.png" alt="">
                            ...
                            <div class="space-casinos-3-archive-item-button box-20 relative">
                                <div class="space-casinos-3-archive-item-button-ins box-100 text-center relative">
                                    <a href="<?php echo esc_url($external_link_url); ?>"
                                       ...
                                       <?php if ($external_link) { ?>target="_blank"
                                       rel="nofollow"<?php } ?>> <?php echo esc_html($button_title); ?></a>

                                    <a class="item-button-readRewie-botton" href="<?php the_permalink(); ?>"
                                       title="<?php echo esc_attr($permalink_button_title); ?>"><?php echo esc_html($permalink_button_title); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
