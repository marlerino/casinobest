...
function aces_games_shortcode_4($atts) {
	...
	<div class="space-shortcode-wrap space-shortcode-7 relative relative">
		...
		<div class="space-games-sidebar-items box-100 relative">
			...
			<div class="space-games-sidebar-item <?php if ($columns == 1) { ?>box-100<?php } else if ($columns == 2) { ?>box-50<?php } else if ($columns == 3) { ?>box-33<?php } else { ?>box-25<?php } ?> relative">
				<div class="space-games-sidebar-item-ins-wrap relative">
					<div class="space-games-sidebar-item-ins box-100 relative">
						<div class="space-games-sidebar-item-img left relative">
							<?php $widget_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-50-50'); if ($widget_img) { ?>
							<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>"><img src="<?php echo esc_url($widget_img[0]); ?>" alt="<?php the_title_attribute(); ?>"></a>
							<?php } ?>
						</div>
