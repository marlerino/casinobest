...
function aces_games_shortcode_2($atts) {
	...
	?>
		...
		<div class="space-shortcode-wrap space-games-shortcode-2 relative">
								...
								<div class="space-games-2-archive-item-overlay space-overlay absolute">
									...
									?>
										...
										<div class="space-games-2-archive-item-rating absolute">
											...
											<strong><?php echo esc_html( number_format( round( $game_rating, 1 ), 1, '.', ',') ); ?></strong><?php echo esc_html( '/5', 'aces' ); ?>
										</div>
