...
function aces_geolocation_settings_init() {
    ...
    function aces_geolocation_tab_enable_callback( $args ) {
        ...
        <p id="<?php echo esc_attr( $args['id'] ); ?>">
            <a href="https://db-ip.com/?refid=sthm" target="_blank"><?php esc_html_e( 'DB-IP.com', 'aces' ); ?></a> <?php esc_html_e( 'provides API for the geolocation service.', 'aces' ); ?> <strong><?php esc_html_e( 'The Free API is limited to 1,000 daily requests.', 'aces' ); ?></strong>
        </p>
        <?php
    }
