...
/*  Display #3 Games Homepage Widget  */
	...
	<div class="space-games-home-3-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-games-home-3-widget-ins space-page-wrapper relative">
