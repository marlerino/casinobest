...
class aces_games_home_widget_2 extends WP_Widget {

/*  #2 Games Homepage Widget Setup  */

	public function __construct() {
		parent::__construct(false, $name = esc_html__('#Aces Games-2', 'aces' ), array(
			'description' => esc_html__('#2 Games widget for the HOMEPAGE (Mercury theme).', 'aces' )
		));
	}

/*  Display #2 Games Homepage Widget  */
	...
	public function widget( $args, $instance ) {
		...
		if ( ! empty( $categories ) ) {
			...
			$second_query = new WP_Query( apply_filters( 'widget_posts_args', array(
				'posts_per_page'   => 4,
				'post_type'        => 'game',
				'no_found_rows'    => true,
				'post_status'      => 'publish',
	...
	<div class="space-games-home-2-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-games-home-2-widget-ins space-page-wrapper relative">
			...
			<div class="space-games-2-archive-columns box-100 relative">
				<div class="space-games-2-archive-column box-50 relative first">
					...
					<div class="space-games-2-archive-item box-100 relative">
						<div class="space-games-2-archive-item-ins relative">
							<div class="space-games-2-archive-item-img-wrap box-100 relative">
								<?php $big_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-570-570'); if ($big_img) { ?>
									<img src="<?php echo esc_url($big_img[0]); ?>" alt="<?php the_title_attribute(); ?>">
								<?php } ?>
								<div class="space-games-2-archive-item-overlay space-overlay absolute">

									<?php if ($game_rating) {
										if( function_exists('wp_star_rating') ){
									?>

										<div class="space-games-2-archive-item-rating absolute">
											...
											<strong><?php echo esc_html( number_format( round( $game_rating, 1 ), 1, '.', ',') ); ?></strong><?php echo esc_html__( '/5', 'aces' ); ?>
										</div>
									...
									<div class="space-games-2-archive-item-central text-center relative">

										<?php if ($terms) { ?>
										<div class="space-games-2-archive-item-category relative">
										...
										<div class="space-games-2-archive-item-title relative">
											<?php the_title(); ?>
										</div>

										<?php if ($external_link) { ?>

										<div class="space-games-2-archive-item-button1 relative">
										...
										<div class="space-games-2-archive-item-button2 relative">
									...
									<div class="space-games-2-archive-item-tac absolute">
				...
				<div class="space-games-2-archive-column box-50 relative second">
					<div class="space-games-2-archive-items box-100 relative">
					...
					<div class="space-games-2-archive-item box-50 relative">
						<div class="space-games-2-archive-item-ins relative">
							<div class="space-games-2-archive-item-img-wrap box-100 relative">
								<?php $big_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-570-570'); if ($big_img) { ?>
									<img src="<?php echo esc_url($big_img[0]); ?>" alt="<?php the_title_attribute(); ?>">
...
/*  Update #2 Games Homepage Widget  */
...
/*  #2 Games Homepage Widget Settings Form  */
...
add_action( 'widgets_init', 'aces_games_home_widget_2' );

function aces_games_home_widget_2() {
	register_widget( 'aces_games_home_widget_2' );
}