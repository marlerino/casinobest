...
class aces_casinos_home_4_widget extends WP_Widget {

/*  #6 Casinos Homepage Widget Setup  */

	public function __construct() {
		parent::__construct(false, $name = esc_html__('#Aces Casinos-6', 'aces' ), array(
			'description' => esc_html__('#6 Casinos widget for the HOMEPAGE (Mercury theme).', 'aces' )
		));
	}

/*  Display #6 Casinos Homepage Widget  */
	...
	<div class="space-casinos-home-4-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
...
/*  Update #6 Casinos Homepage Widget  */
...
/*  #6 Casinos Homepage Widget Settings Form  */
...
add_action( 'widgets_init', 'aces_casinos_home_4_widget' );

function aces_casinos_home_4_widget() {
	register_widget( 'aces_casinos_home_4_widget' );
}