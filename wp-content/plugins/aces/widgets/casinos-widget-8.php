...
/*  Display #8 Casinos Homepage Widget  */
	...
	<div class="space-casinos-home-6-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-casinos-home-6-widget-ins space-page-wrapper relative">
			...
			?>
				...
				<div class="space-casinos-6-archive-item box-25 relative">
					<div class="space-casinos-6-archive-item-ins relative">
						<div class="space-casinos-6-archive-item-img-wrap box-100 relative">
							...
							<div class="space-casinos-6-archive-item-overlay space-overlay absolute">
								...
								<div class="space-casinos-6-archive-item-tac absolute">
