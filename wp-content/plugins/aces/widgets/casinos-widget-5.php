...
/*  Display #5 Casinos Homepage Widget  */
	...
	<div class="space-casinos-home-3-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
					...
					<div class="space-casinos-3-archive-item-ins relative">
						<div class="space-casinos-3-archive-item-logo box-20 relative">
							<div class="space-casinos-3-archive-item-logo-ins box-100 text-center relative">
								...
								<span class="casino-name-span"><?php the_title_attribute(); ?></span>
								<?php } ?>
							</div>
