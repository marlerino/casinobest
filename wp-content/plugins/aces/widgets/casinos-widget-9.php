...
/*  #9 Casinos Homepage Widget  */

class aces_casinos_home_9_widget extends WP_Widget {

/*  #9 Casinos Homepage Widget Setup  */

	public function __construct() {
		parent::__construct(false, $name = esc_html__('#Aces Casinos-9', 'aces' ), array(
			'description' => esc_html__('#9 Casinos widget for the HOMEPAGE (Mercury theme).', 'aces' )
		));
	}

/*  Display #9 Casinos Homepage Widget  */
	...
	<div class="space-casinos-home-7-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-casinos-home-7-widget-ins space-page-wrapper relative">
...
/*  Update #9 Casinos Homepage Widget  */
...
/*  #9 Casinos Homepage Widget Settings Form  */
...
add_action( 'widgets_init', 'aces_casinos_home_9_widget' );

function aces_casinos_home_9_widget() {
	register_widget( 'aces_casinos_home_9_widget' );
}