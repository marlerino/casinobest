...
class aces_casinos_home_7_widget extends WP_Widget {

/*  #7 Casinos Homepage Widget Setup  */

	public function __construct() {
		parent::__construct(false, $name = esc_html__('#Aces Casinos-7', 'aces' ), array(
			'description' => esc_html__('#7 Casinos widget for the HOMEPAGE (Mercury theme).', 'aces' )
		));
	}

/*  Display #7 Casinos Homepage Widget  */
	...
	<div class="space-casinos-home-5-widget homepage-block box-100 relative"<?php if ( $margin_bottom ) { ?> style="margin-bottom: <?php echo esc_attr($margin_bottom); ?>;"<?php } ?>>
		<div class="space-casinos-home-5-widget-ins space-page-wrapper relative">
			...
			<div class="space-casinos-5-archive-columns box-100 relative">
				<div class="space-casinos-5-archive-column box-50 relative first">
					...
					<div class="space-casinos-5-archive-item box-100 relative">
						<div class="space-casinos-5-archive-item-ins relative">
							<div class="space-casinos-5-archive-item-img-wrap box-100 relative">
								...
								<?php } ?>
								<div class="space-casinos-5-archive-item-overlay space-overlay absolute">

									<?php if( function_exists('wp_star_rating') ){ ?>

										<div class="space-casinos-5-archive-item-rating absolute">
									...
									<div class="space-casinos-5-archive-item-central text-center relative">

										<?php if ($terms) { ?>
										<div class="space-casinos-5-archive-item-category relative">
										...
										<div class="space-casinos-5-archive-item-title relative">
											<?php the_title(); ?>
										</div>

										<?php if ($external_link) { ?>

										<div class="space-casinos-5-archive-item-button1 relative">
										...
										<div class="space-casinos-5-archive-item-button2 relative">
									...
									<div class="space-casinos-5-archive-item-tac absolute">
				...
				<div class="space-casinos-5-archive-column box-50 relative second">
					<div class="space-casinos-5-archive-items box-100 relative">
					...
					<div class="space-casinos-5-archive-item box-50 relative">
						<div class="space-casinos-5-archive-item-ins relative">
							<div class="space-casinos-5-archive-item-img-wrap box-100 relative">
								<?php $big_img = wp_get_attachment_image_src(get_post_thumbnail_id(), 'mercury-570-570'); if ($big_img) { ?>
									<img src="<?php echo esc_url($big_img[0]); ?>" alt="<?php the_title_attribute(); ?>">
...
/*  Update #7 Casinos Homepage Widget  */
...
/*  #7 Casinos Homepage Widget Settings Form  */
...
add_action( 'widgets_init', 'aces_casinos_home_7_widget' );

function aces_casinos_home_7_widget() {
	register_widget( 'aces_casinos_home_7_widget' );
}